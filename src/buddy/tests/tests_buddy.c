...
void test_buddy_tree_init(void) {
	...
	size_t size;
	start_test;
	assert(buddy_tree_init(buddy_tree_buf, 8, &size) != NULL);
}
...
void test_buddy_tree_valid(void) {
	...
	size_t size;
	start_test;
	t = buddy_tree_init(buddy_tree_buf, 8, &size);
...
void test_buddy_tree_left_child(void) {
	...
	size_t size;
	start_test;
	t = buddy_tree_init(buddy_tree_buf, 2, &size);
	pos = buddy_tree_root();
...
void test_buddy_tree_mark_status_release_01(void) {
	...
	size_t size;
	start_test;
	t = buddy_tree_init(buddy_tree_buf, 1, &size);
	pos = buddy_tree_root();
...
void test_buddy_tree_mark_status_release_03(void) {
	...
	size_t size;
	start_test;
	t = buddy_tree_init(buddy_tree_buf, 3, &size);
	pos = buddy_tree_root();
	assert(buddy_tree_status(t, pos) == 0);
	buddy_tree_mark(t, pos);
...
void test_buddy_tree_mark_status_release_04(void) {
	...
	size_t size;
	start_test;
	t = buddy_tree_init(buddy_tree_buf, 4, &size);
	pos = buddy_tree_root();
	assert(buddy_tree_status(t, pos) == 0);
	buddy_tree_mark(t, pos);
