...
#define __CMPXCHG_CASE(w, sz, name, mb, acq, rel, cl)                          \
  __LL_SC_INLINE unsigned long __LL_SC_PREFIX(__cmpxchg_case_##name(           \
...
#define __CMPXCHG_GEN(sfx)                                                     \
  static inline unsigned long __cmpxchg##sfx(                                  \
...
#define __cmpxchg_wrapper(sfx, ptr, o, n)                                      \
  ({                                                                           \
    __typeof__(*(ptr)) __ret;                                                  \
    __ret = (__typeof__(*(ptr)))__cmpxchg##sfx(                                \
...
#define __XCHG_GEN(sfx)                                                        \
  static inline unsigned long __xchg##sfx(unsigned long x, volatile void *ptr, \
                                          int size) {                          \
    switch (size) {                                                            \
    case 1:                                                                    \
...
#define __xchg_wrapper(sfx, ptr, x)                                            \
  ({                                                                           \
    __typeof__(*(ptr)) __ret;                                                  \
    __ret = (__typeof__(*(ptr)))__xchg##sfx((unsigned long)(x), (ptr),         \
                                            sizeof(*(ptr)));                   \
    __ret;                                                                     \
  })
