...
static inline uint32_t atomic_cmpxchg_acquire32(uint32_t *ptr, uint32_t exp,
                                                uint32_t val) {
  uint32_t old;
  ...
  asm volatile(
      ...
      "	nop\n"
      "	nop\n"
      : [tmp] "=&r"(tmp), [old] "=&r"(old), [ptr] "+Q"(*(uint32_t *)ptr)
...
static inline uint32_t atomic_cmpxchg_release32(uint32_t *ptr, uint32_t exp,
                                                uint32_t val) {
  uint32_t old;
...
static inline uint32_t atomic_cmpxchg_relaxed32(uint32_t *ptr, uint32_t exp,
                                                uint32_t val) {
  uint32_t old;
...
static inline uint16_t xchg_release16(uint16_t *ptr, uint16_t val) {
  ...
  asm volatile("	swplh	%w[val], %w[old], %[ptr]\n"
               "	nop\n"
               "	nop\n"
